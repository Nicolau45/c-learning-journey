/*    Computing the Dimensional Weight of a Box
        ...
        United States, the usual method is to divide the volume by 166 (the allowable number 
        of cubic inches per pound). If this number-the box's "dimensional" or "volumetric" weight-exceeds 
        its actual weight, the shipping fee is based on the
        ...
        to start off by writing a program that calculates the dimensional weight of a particular box 
        that's 12" x 10" x 8". Division is represented by / in C, so the obvious
        ...
        point are lost. The volume of a 12" x 10" x8" box will be 960 cubic inches. Dividing by 166 
        gives the answer 5 instead of 5.783, so we have in effect rounded down
        to the next lowest pound; the shipping company expects us to round up. One solution is to add 165
